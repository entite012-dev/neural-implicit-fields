...
TRAIN_BATCH_SIZE = 65536  # RTX 3050 ki 6GB VRAM ke liye optimal batch size , aur apne hisab se set kar le 
...
# ==============================================================================
extracted_snapshot = {
    "image_id": "glasses_001",                 # Glasses ke liye change to "glasses_001"
    "prompt_token": 1,                     # Dog = 0, Glasses = 1
    "omega_0": OMEGA_0,                    
    "flat_weights_vector": flat_model_row   
}

output_filename = "extracted_siren_data_002.pt"  # Glasses ke liye change to "extracted_siren_data_002.pt"
